...
urlpatterns = [
    ...
    path("healthz/cron/", views.healthz_cron, name="healthz_cron"),
    ...
    path("embed/", views.embed_map_view, name="embed_map"),
    ...
    path("api/events/<uuid:event_id>/flyer/", views.event_flyer_view, name="api_event_flyer"),
    ...
    path("api/challenges/", views.challenges_list_api, name="api_challenges_list"),
    path("api/challenges/<slug:challenge_slug>/", views.challenge_detail_api, name="api_challenge_detail"),
